...
class FournisseurInformations extends StatefulWidget {
  const FournisseurInformations({Key? key}) : super(key: key);

  @override
  State<FournisseurInformations> createState() =>
      _FournisseurInformationsState();
}

class _FournisseurInformationsState extends State<FournisseurInformations> {
  File? image;
